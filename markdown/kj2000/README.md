# King James 2000
 ...
 The King James 2000 is not a new version. It is a King James Version brought
  ...
  language. Pronouns such as thy, thine, thou, ye, etc. are put into current
  language usage form. Verbal endings such as -eth, -est, -st, etc. are given
  equivalent forms of today’s language. Words so archaic as to be unknown, such
  as wist, wot, froward, etc. are rendered as their current synonyms. Some
  words considered entirely proper in 1611, but which may be considered
  »coarse« today, are changed to equivalent intentions (such as bowels to
  heart). The common Biblical beast of burden is rendered donkey.
